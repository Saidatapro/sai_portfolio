const data = {
    ...
    volunteering: [
        ...
        },
        {
            ...
            match: "Organizer",
            image: "assets/dandiya_night.png"
        }
    ],
    honors: [
        {
...
window.addEventListener('load', () => {
    ...
    // Netflix intro usually stays for ~2.5-3 seconds
    setTimeout(() => {
        if (introScreen) {
